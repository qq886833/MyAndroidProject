...
public class ImageSizeUtil {
    ...
    public static final int BANNER_H_1 = 1280;
    public static final int BANNER_H_2 = 900;
    public static final int BANNER_H_3 = 600;
    ...
    private static String getUrl(String url, int width, int height) {
        ...
        LogUtils.LOGE(LogUtils.TYPE_DEBUG, "img===========" + s);
        return s;
    }
