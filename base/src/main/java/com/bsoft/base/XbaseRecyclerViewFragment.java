...
import com.bsoft.ui.base.BaseFragment;
import com.bsoft.utils.DensityUtil;
...
public abstract class XbaseRecyclerViewFragment extends XbaseFragment {
    ...
    public void showErrorView() {
        ...
        if (isEmpty()) {
           ...
           // EToastUtils.show("加载失败");
            Toast.makeText(baseContext.getApplicationContext(), "加载失败", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void showErrorView(String error) {
        ...
        if (isEmpty()) {
            ...
            Toast.makeText(baseContext.getApplicationContext(), error, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void showEmptyView() {
        if (isEmpty()) {
          ...
          //  EToastUtils.show("数据为空");
            Toast.makeText(baseContext.getApplicationContext(), "数据为空", Toast.LENGTH_SHORT).show();
        }
    }

    public void showEmptyView(int layoutId) {
        if (isEmpty()) {
            super.showEmptyViewLayoutId(layoutId);
        } else {
           // EToastUtils.show("数据为空");
            Toast.makeText(baseContext.getApplicationContext(), "数据为空", Toast.LENGTH_SHORT).show();
        }
